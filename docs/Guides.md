...
3. In Docker: Öffne **local_docker_netbox_certificate_management_plugin**.
...
3. Um Migrationen zu erstellen, führe im Terminal den Befehl:
   ...
   ```shell
   docker-compose run netbox sh -c "python manage.py makemigrations netbox_certificate_management
   ```
